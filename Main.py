...
if __name__ == '__main__':
    for account in Config.ACCOUNTS:
        ...
        TargetHelper.sync_photo(photo_paths=photo_paths,username=Config.PP_USERNAME,password=Config.PP_PASSWORD,base_url=Config.PP_BASE_URL,sync_dir=sync_album_name)
